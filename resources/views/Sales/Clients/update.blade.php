@extends('layouts.vertical', ['title' => 'تعديل عميلء'])
@section('content')
                  ...
                  <div class="col-lg-12 mt-3">
                     <ul class="d-flex align-content-center">
                        ...
                        <li class="text-primary">
                           <i class="fa fa-angle-double-left mx-2 "></i><a href="add-client.html">تعديل عميل</a>
                        </li>
                     </ul>
                  </div>
               </div>
                           ...
                           <form action="{{ route('client.edit', $Client->id)}}" method="post">
                            @csrf
                              <div class="d-flex align-content-center justify-content-sm-between">
                                 <label class="mt-3 ml-5">اسم العميل</label><input value="{{ $Client->name }}" name="name" type="text"  class="form-control w-75 my-2">
                              </div>
                              <div class="d-flex align-content-center justify-content-sm-between">
                                 <label class="mt-3 ml-5">رقم الاتصال الأساسي</label><input value="{{ $Client->phon }}" name="phon" type="text" class="form-control w-75 my-2">
                              </div>
                              <div class="d-flex align-content-center justify-content-sm-between">
                                 <label class="mt-3 ml-5">رقم الاتصال الثانوي</label><input value="{{ $Client->phon2 }}" name="phon2" type="text" class="form-control w-75 my-2">
                              </div>
                              <div class="d-flex align-content-center justify-content-sm-between">
                                 <label class="mt-3 ml-5">البريد الإلكتروني الأساسي</label><input value="{{ $Client->email }}" name="email" type="text" class="form-control w-75 my-2">
                              </div>
                              <div class="d-flex align-content-center justify-content-sm-between">
                                 <label class="mt-3 ml-5">البريد الإلكتروني الثانوي</label><input value="{{ $Client->email2 }}" name="email2" type="text" class="form-control w-75 my-2">
                              </div>
                              <div class="d-flex align-content-center justify-content-sm-between">
                                 <label class="mt-3 ml-5">اسم المنشأة</label><input value="{{ $Client->Facility }}" name="Facility" type="text" class="form-control w-75 my-2">
                              </div>
                              <div class="d-flex align-content-center justify-content-sm-between">
                                 <label class="mt-3 ml-5">الموقع الالكتروني</label><input value="{{ $Client->webName }}" name="webName" type="text" class="form-control w-75 my-2">
                              </div>
                              <div class="d-flex align-content-center justify-content-sm-between">
                                 <label class="mt-3 ml-5">الرقم الضريبي</label><input value="{{ $Client->Tex_Number }}" name="Tex_Number" type="text" class="form-control w-75 my-2">
                              </div>
                              <div class="d-flex align-content-center justify-content-sm-between">
                                 <label class="mt-3 ml-5">الحالة</label>
                                 <select class="form-control w-75" name="status" id="">
                                    <optgroup>
                                       <option {{ $Client->status == 1 ? 'selected' : '' }} value="1">نشط</option>
                                       <option {{ $Client->status == 0 ? 'selected' : '' }} value="0">غير نشط</option>
                                    </optgroup>
                                 </select>
                              </div>
                              <div class="d-flex align-content-center justify-content-sm-between">
