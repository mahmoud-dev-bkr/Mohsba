                  ...
                  <div class="col-lg-12 mt-3">
                     <ul class="d-flex align-content-center">
                        ...
                        <li class="text-primary">
                           <i class="fa fa-angle-double-left mx-2 "></i><a href="add-bonds.html"> انشاء سند</a>
                        </li>
                     </ul>
                  </div>
               </div>
                  ...
                  <div class="row bg-light pb-4 brdr">
                        <form action="" method="post">
                            ...
                            <div class="btn-holder">
                                <button class="btn btn-primary submit">حفظ</button> <button class="btn btn-dark re-submit">الغاء</button>
                            </div>
                        </form>
                    </div>
               </div>
