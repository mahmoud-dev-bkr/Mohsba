            ...
            <div   id="wrapper">
                                ...
                                <li >
                                    <a href="customer-bonds.html" class="nav-link px-0">
                                        <div class="space"><span class="d-none d-sm-inline text">
                                            ...
                                            <span>
                                    <a href="add-bonds.html"><i class="fa-solid fa-plus plus"></i></a></div> </a>
                                </li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <div class="col-lg-12 mt-3">
                            <ul class="d-flex align-content-center">
                                ...
                                <li class="text-primary">
                                    <i class="fa fa-angle-double-left mx-2 "></i><a href="Sales-invoices.html">فواتير المبيعات</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <section>
                    <div class="d-flex justify-content-sm-end mx-5">
                        ...
                        <button class="btn btn-primary mx-2"><a href="add-sales-bill.html" class="text-light"> انشاء فاتورة </a>   <i class="fa-solid fa-plus mx-1"></i></button>
                        <button class="btn btn-primary mx-2">  الإشعارات الدائنة  </button>
                        <button class="btn btn-primary mx-2">  ادارة السندات  </button>
                    </div>
                    <div class="container my-3">
                        <div class="row">
                            <div class="col-md-12 hi-mohasba">
                                <h4 class="mx-4">فواتير المبيعات</h4>
                            </div>
                        </div>
                        <div class="row bg-light pb-4 brdr">
                            <div class="col-md-12 clients ">
                                <div>
                                    ...
                                    <p class="text-secondary my-5 w-50 m-auto">يتيح لك قيود خاصية إنشاء فواتير المبيعات وهي وثائق تجارية صادرة من البائع للمشتري، تبين المنتجات أو الخدمات المقدمة, وكمياتها, وأسعارها.</p>
                                    <button class="btn btn-primary mx-2"> <a href="add-sales-bill.html" class="text-light"> انشاء فاتورة </a>  <i class="fa-solid fa-plus"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
